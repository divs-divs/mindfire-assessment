...
class AircraftsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create aircraft" do
    assert_difference('Aircraft.count') do
      post aircrafts_url, params: { aircraft: { aircraft_no: @aircraft.aircraft_no, airline: @aircraft.airline, destination: @aircraft.destination, source: @aircraft.source } }, as: :json
    end
  ...
  test "should update aircraft" do
    patch aircraft_url(@aircraft), params: { aircraft: { aircraft_no: @aircraft.aircraft_no, airline: @aircraft.airline, destination: @aircraft.destination, source: @aircraft.source } }, as: :json
    assert_response 200
  end
