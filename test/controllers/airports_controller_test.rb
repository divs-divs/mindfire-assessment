...
class AirportsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create airport" do
    assert_difference('Airport.count') do
      post airports_url, params: { airport: { airport_name: @airport.airport_name, fuel_available: @airport.fuel_available, fuel_capacity: @airport.fuel_capacity } }, as: :json
    end
  ...
  test "should update airport" do
    patch airport_url(@airport), params: { airport: { airport_name: @airport.airport_name, fuel_available: @airport.fuel_available, fuel_capacity: @airport.fuel_capacity } }, as: :json
    assert_response 200
  end
